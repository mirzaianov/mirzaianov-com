  ...
  work: [
    {
      ...
      description: [
        ...
        'Engineered 3 modern SPAs using React, Next, Tailwind & Redux, leading to a 30% improvement in user interactions & page load times',
        ...
        'Overhauled 2 JS projects, ensuring cross-browser compatibility and adaptive, responsive layouts, driving a 150% surge in conversion rates',
        'Led a collaboration with a backend team, integrating RESTful APIs into frontend apps, enhancing data retrieval efficiency by 40%',
    ...
    },
    {
      ...
      description: [
        'Relocated internationally, enhancing adaptability and cross-cultural skills, yielding a 50% increase in teamwork efficiency',
        ...
        'Built 15+ pet & test projects from scratch with help of Git & Jira, scaling up time management capabilities by 50%',
    ...
    },
    {
      ...
      description: [
        'Completed 3 localization projects of Air Disk Brake (ADB) components, resulting in a serial manufacturing and a 1.5x client satisfaction increase',
        'Implemented 100+ devices, toolings and equipment, boosting efficiency of production lines, measuring and testing laboratories up to 30%',
